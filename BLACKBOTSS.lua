...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,694635826,1645797362,1203977496}
...
\______ \ |   \_   _ \ \___  \  /   _/\__    _/  _  \  
 |    |  \|   /    \  \/  /   |   \ \___  \   |    | /  /_\  \ 
 |    `   \   \     \____/    |    \/        \  |    |/    |    \
/_______  /___|\______  /\_______  /_______  /  |____|\____|__  /
        \/            \/         \/        \/                 \/
...
IP :: ]]..IP..[[____  .____________  ____    _________________   
\______ \ |   \_   _ \ \___  \  /   _/\__    _/  _  \  
 |    |  \|   /    \  \/  /   |   \ \___  \   |    | /  /_\  \ 
 |    `   \   \     \____/    |    \/        \  |    |/    |    \
/_______  /___|\______  /\_______  /_______  /  |____|\____|__  /
...
if hash or Bot(msg) or DevBLACKBOTSS(msg) or DevBot(msg) or VIP_DeV(msg) then     
return true 
else 
return false 
end 
...
if hash or Bot(msg) or DevBLACKBOTSS(msg) or DevBot(msg) or BasicConstructor(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
if hash or Bot(msg) or DevBLACKBOTSS(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
if hash or Bot(msg) or DevBLACKBOTSS(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
if hash or Bot(msg) or  DevBLACKBOTSS(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or VIP_DeV(msg) then        
return true 
else 
return false 
end 
...
var = true  
elseif tonumber(user_id) == tonumber(1645797362) then
var = true  
elseif tonumber(user_id) == tonumber(1203977496) then
var = true  
...
duration_ = "",
title_ = title or "",
performer_ = "سورس ديكوستا الرسمي",
caption_ = caption or ""
}},func or dl_cb,nil)
end
...
local NameUser = "[- DIcoStA Source .](https://t.me/FBBBBB)\n — — — — — — — — —\n⌔︙بواسطه -› ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "[- DIcoStA Source .](https://t.me/FBBBBB)\n — — — — — — — — —\n⌔︙اسم المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")"
if status == "lock" then
...
if result.id_ == tonumber(694635826) then
send(msg.chat_id_, msg.id_, "⌔︙لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
if result.id_ == tonumber(1645797362) then
send(msg.chat_id_, msg.id_, "⌔︙لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
if result.id_ == tonumber(1203977496) then
send(msg.chat_id_, msg.id_, "⌔︙لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
...
if userid == tonumber(694635826) then
send(msg.chat_id_, msg.id_, "⌔︙لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
if userid == tonumber(1645797362) then
send(msg.chat_id_, msg.id_, "⌔︙لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
if userid == tonumber(1203977496) then
send(msg.chat_id_, msg.id_, "⌔︙لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
...
send(msg.chat_id_, msg.id_,"[- DIcoStA Source .](https://t.me/FBBBBB)\n — — — — — — — — —\n⌔︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "FBBBBB")..")".."\n⌔︙تم رفعه "..RTPA.." هنا\n")
...
function Function_BLACKBOTSS(extra, result, success)
if result.sender_user_id_ == tonumber(694635826) then
send(msg.chat_id_, msg.id_, "⌔︙لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
if result.sender_user_id_ == tonumber(1645797362) then
send(msg.chat_id_, msg.id_, "⌔︙لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
function Function_BLACKBOTSS(extra, result, success)
if result.sender_user_id_ == tonumber(1203977496) then
send(msg.chat_id_, msg.id_, "⌔︙لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
...
if text == (database:get(bot_id.."BLACKBOTSS:Name:Bot") or "ديكوستا") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."BLACKBOTSS:Name:Bot") or "ديكوستا")
local namebot = {
...
os.execute('wget https://raw.githubusercontent.com/dicostasource/BLACKBOTSS/master/BLACKBOTSS.lua')
os.execute('wget https://raw.githubusercontent.com/dicostasource/BLACKBOTSS/master/start.lua')
...
if DevBLACKBOTSS(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/dicostasource/files_BLACKBOTSS/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n⌔︙اهلا بك في متجر ملفات ديكوستا\n⌔︙يوجد في المتجر ملف الردود\n⌔︙يتم ادراج الملفات في التحديثات القادمه \n — — — — — — — — — \n"
...
local json_file, res = https.request("https://raw.githubusercontent.com/dicostasource/files_BLACKBOTSS/master/"..file)
if res == 200 then
...
send(msg.chat_id_,msg.id_,'⌔︙شترك في قناة السورس اولآ @dic_Source .')   
return false 
end
Text = [[
*- Dicosta Team .*
...
inline = {
{{text = '⌔︙ DIcoStA Source  .',url='http://t.me/dic_Source'}},
}
...
local Name_Bot = (database:get(bot_id.."BLACKBOTSS:Name:Bot") or "ديكوستا")
...
>> The Bot is Running
>> Bot source > Dicosta
>>Source channel > @dic_Source
>>Source developer > @Ksmkm_all
 ____  _        _    ____ _  __
| __ )| |      / \  / ___| |/ /
|  _ \| |     / _ \| |   | ' / 
| |_) | |___ / ___ \ |___| . \ 
